  ...
  return (
    ...
    <div>
        ...
        <Box>
            ...
            <Text className={styles.variety}fontSize="0.9rem" fontWeight={700}><Code  variant="none" fontSize="1rem" fontWeight={600} >New Arrivals</Code>{data.length? data.length : product.length} Designs</Text>
        </Box>
